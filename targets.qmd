...
1. Download [this R project](https://github.com/louisahsmith/reproducible-epi-workshop) as a zip file (green "Code" button -> "Download ZIP"). (If you are familiar with git/github, feel free to clone it directly.)
